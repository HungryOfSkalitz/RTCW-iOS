...
extension SDL_uikitviewcontroller {
    ...
    @objc func firePressed(_ sender: UIButton) {
        Key_Event(130, qboolean(rawValue: 1), qboolean(rawValue: 1))
    }
    
    @objc func fireReleased(_ sender: UIButton) {
        Key_Event(130, qboolean(rawValue: 0), qboolean(rawValue: 1))
    }
    
    @objc func jumpPressed(_ sender: UIButton) {
        Key_Event(131, qboolean(rawValue: 1), qboolean(rawValue: 1))
    }
    
    @objc func jumpReleased(_ sender: UIButton) {
        Key_Event(131, qboolean(rawValue: 0), qboolean(rawValue: 1))
    }
    
    @objc func usePressed(_ sender: UIButton) {
        Key_Event(101, qboolean(rawValue: 1), qboolean(rawValue: 1))
    }
    
    @objc func useReleased(_ sender: UIButton) {
        Key_Event(101, qboolean(rawValue: 0), qboolean(rawValue: 1))
    }
    
    @objc func crouchPressed(_ sender: UIButton) {
        crouching = !crouching
        Key_Event(136, crouching ? qboolean(rawValue: 1) : qboolean(rawValue: 0), qboolean(rawValue: 1))
    }
    
    @objc func prevWeaponPressed(_ sender: UIButton) {
        Key_Event(91, qboolean(rawValue: 1), qboolean(rawValue: 1))
        DispatchQueue.main.asyncAfter(deadline: .now() + 0.1) {
            Key_Event(91, qboolean(rawValue: 0), qboolean(rawValue: 1))
        }
    }
    
    @objc func nextWeaponPressed(_ sender: UIButton) {
        Key_Event(93, qboolean(rawValue: 1), qboolean(rawValue: 1))
        DispatchQueue.main.asyncAfter(deadline: .now() + 0.1) {
            Key_Event(93, qboolean(rawValue: 0), qboolean(rawValue: 1))
        }
    }
...
extension SDL_uikitviewcontroller: JoystickDelegate {
    ...
    func handleJoyStick(angle: CGFloat, displacement: CGFloat) {
        ...
        Key_Event(119, dy < -0.35 ? qboolean(rawValue: 1) : qboolean(rawValue: 0), qboolean(rawValue: 1))
        Key_Event(115, dy > 0.35  ? qboolean(rawValue: 1) : qboolean(rawValue: 0), qboolean(rawValue: 1))
        
        
        Key_Event(97,  dx < -0.35 ? qboolean(rawValue: 1) : qboolean(rawValue: 0), qboolean(rawValue: 1))
        Key_Event(100, dx > 0.35  ? qboolean(rawValue: 1) : qboolean(rawValue: 0), qboolean(rawValue: 1))
    }
}
